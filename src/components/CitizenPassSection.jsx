      ...
      <div className="mx-auto flex flex-col items-center md:items-center md:justify-center w-full md:max-w-6xl">
        ...
        <div className="text-white py-16">
          <div className="max-w-7xl flex flex-col md:flex-row md:h-[867px] rounded mx-4">
            ...
            <div
              className="py-10 px-0 md:p-8 flex flex-col items-center md:justify-center relative md:w-1/3 rounded-t-lg md:rounded-l-lg"
              style={{
            ...
            <div className="flex flex-col md:items-center bg-[#EBEBEB] rounded-b-lg md:rounded-r-lg">
              <div className="flex flex-col md:flex-row justify-center items-center md:items-start p-4 md:p-8">
                ...
                <div className="relative bg-white text-black p-8 border border-[#E94A41] rounded-lg shadow-lg relative md:h-[694px]">
                ...
                <button className="md:hidden block bg-[#4C58F2] text-white text-sm py-2 px-6 mt-4 rounded-lg">
                  Become a citizen
                </button>
              </div>
              <button className="hidden md:block bg-[#4C58F2] text-white text-sm py-2 px-6 mt-4 rounded-lg text-center">
                Become a citizen
              </button>
            </div>
          </div>
